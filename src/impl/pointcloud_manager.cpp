...
{
void PointCloudManager::scanToPoints(
  sensor_msgs::msg::LaserScan::SharedPtr msg, std::vector<PointWithNormal> & vec)
{
  toPoints(msg, vec);
  resamplePoints(vec);
  analysePoints(vec);
...
void PointCloudManager::toPoints(
  sensor_msgs::msg::LaserScan::SharedPtr msg, std::vector<PointWithNormal> & vec)
{
...
bool PointCloudManager::calNormal(
