...
public:
  ...
  ~PointCloudManager(){};
  void scanToPoints(sensor_msgs::msg::LaserScan::SharedPtr msg, std::vector<PointWithNormal> & vec);

private:
  std::string laser_frame;
  void toPoints(sensor_msgs::msg::LaserScan::SharedPtr msg, std::vector<PointWithNormal> & vec);
  ...
  bool calNormal(
    size_t idx, std::vector<PointWithNormal> & lps, bool isForward, Eigen::Vector2d & normal);
};
